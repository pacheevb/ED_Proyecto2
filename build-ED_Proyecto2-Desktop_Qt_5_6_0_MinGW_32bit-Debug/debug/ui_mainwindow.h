...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_aerolinea->setGeometry(QRect(490, 530, 151, 51));
        btn_aerolinea->setFlat(true);
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(380, 90, 361, 411));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Men\303\272 Principal", 0));
